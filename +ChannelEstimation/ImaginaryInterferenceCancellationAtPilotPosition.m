...
% www.tc.tuwien.ac.at    
% This Matlab code is based on the paper: 
% R. Nissel, M. Rupp, "ON PILOT-SYMBOL AIDED CHANNEL ESTIMATION IN FBMC-OQAM" 
   ...
   methods
      ...
      function obj = ImaginaryInterferenceCancellationAtPilotPosition(varargin)
          ...
          Method = varargin{1};
          PilotMatrix = varargin{2};
          FBMCMatrix = varargin{3};         
          NrCanceledInterferersPerPilot = varargin{4}; 
          PilotToDataPowerOffset = varargin{5};       
          ...
          switch Method
              ...
              case 'Coding'
                  NrPilotSymbols = sum(PilotMatrix(:)==1);
                  NrDataSymbols =  sum(PilotMatrix(:)==0)-NrPilotSymbols;
